...
Properties.OnPlayerProperty.Add(function (c, v) 
{
   let p = c.Player,
   nam = v.Name;
   if (nam != 'info1') p.Team.Properties.Get('info1').Value = 'Звание: ddjdj' + n + n + '<size=80>kills: ' + p.Team.Properties.Get('kills').Value + ', wins: ' + p.Team.Properties.Get('wins').Value + '</size>';
});
